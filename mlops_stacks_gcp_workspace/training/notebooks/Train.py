...
# ``mlops_stacks_gcp_workspace/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_stacks_gcp_workspace-experiment",
    label="MLflow experiment name",
)
# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-mlops_stacks_gcp_workspace-model", label="Model Name"
)
