...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_stacks_gcp_workspace-run-tests.yml) 
...
* [Staging workspace registered model](https://416411475796958.8.gcp.databricks.com/ml/models/staging-mlops_stacks_gcp_workspace-model)
* [Prod workspace registered model](https://416411475796958.8.gcp.databricks.com/ml/models/prod-mlops_stacks_gcp_workspace-model). 
